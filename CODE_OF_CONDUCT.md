...
- Use of sexualized language or imagery, or unwelcome attention or advances.
...
This Code of Conduct applies within all community spaces — the repository, issues, pull requests, and discussions — and also applies when an individual is officially representing the community in public spaces.
...
1. **Correction** — A private, written warning providing clarity around the nature of the violation and why the behavior was inappropriate. A public apology may be requested.
