...
| `active_artifact_id` | str(36)? FK→voice_variant_artifacts | active version pointer (ADR-0009); NULL while pending/failed |
| `error_message` | text? | last build failure detail (ADR-0008) |
